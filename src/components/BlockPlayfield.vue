...
.board-cell::before { content: ''; position: absolute; inset: -1px; border: 1px solid color-mix(in srgb, var(--block-color) 62%, white); border-radius: inherit; background: linear-gradient(145deg, color-mix(in srgb, var(--block-color) 48%, white) 0 9%, color-mix(in srgb, var(--block-color) 82%, white) 10% 19%, var(--block-color) 20% 62%, color-mix(in srgb, var(--block-color) 72%, black) 63% 84%, color-mix(in srgb, var(--block-color) 48%, black) 85% 100%); opacity: 0; box-shadow: inset 0 4px 2px rgba(255,255,255,.42), inset 4px 0 3px rgba(255,255,255,.18), inset -4px 0 3px rgba(0,21,37,.2), inset 0 -5px 3px rgba(0,18,34,.34), 0 3px 5px rgba(0,17,30,.36), 0 0 7px color-mix(in srgb, var(--block-color) 32%, transparent); transform: scale(.88); transition: opacity .15s ease, transform .18s cubic-bezier(.2,.8,.25,1.15), filter .15s ease; }
.board-cell::after { content: ''; position: absolute; z-index: 1; inset: 18% 15% 27%; pointer-events: none; border: 1px solid rgba(255,255,255,.18); border-radius: 9%; background: linear-gradient(145deg, rgba(255,255,255,.34), rgba(255,255,255,.08) 42%, rgba(0,18,35,.08) 43% 100%); opacity: 0; box-shadow: inset 0 1px rgba(255,255,255,.3), 0 2px 3px rgba(0,20,35,.12); transition: opacity .15s ease, transform .18s ease; transform: translateY(2px) scale(.82); }
.board-cell.occupied::before { opacity: 1; filter: saturate(1.08); transform: scale(1); }
.board-cell.occupied::after { opacity: .78; transform: translateY(0) scale(1); }
.board-cell.ghost-valid::before { opacity: .58; transform: scale(1); }
.board-cell.ghost-valid::after { opacity: .34; transform: translateY(0) scale(1); }
...
.piece-cell::after { content: ''; position: absolute; z-index: 1; inset: 2px; border: 1px solid color-mix(in srgb, var(--block-color) 62%, white); border-radius: 13%; background: linear-gradient(145deg, color-mix(in srgb, var(--block-color) 45%, white) 0 10%, color-mix(in srgb, var(--block-color) 83%, white) 11% 20%, var(--block-color) 21% 61%, color-mix(in srgb, var(--block-color) 70%, black) 62% 84%, color-mix(in srgb, var(--block-color) 46%, black) 85% 100%); box-shadow: inset 0 4px 2px rgba(255,255,255,.45), inset 4px 0 3px rgba(255,255,255,.17), inset -4px 0 3px rgba(0,17,31,.18), inset 0 -5px 3px rgba(0,18,34,.32), 0 4px 7px rgba(0,25,42,.3), 0 0 7px color-mix(in srgb, var(--block-color) 28%, transparent); }
.piece-cell::before { content: ''; position: absolute; z-index: 2; inset: 19% 17% 30%; pointer-events: none; border: 1px solid rgba(255,255,255,.18); border-radius: 10%; background: linear-gradient(145deg, rgba(255,255,255,.36), rgba(255,255,255,.08) 45%, rgba(0,16,31,.09) 46% 100%); box-shadow: inset 0 1px rgba(255,255,255,.32), 0 2px 3px rgba(0,18,32,.12); }
