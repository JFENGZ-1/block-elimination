...
.board-cell::before { content: ''; position: absolute; inset: 1px; border: 1px solid color-mix(in srgb, var(--block-color) 68%, white); border-radius: inherit; background: linear-gradient(180deg, color-mix(in srgb, var(--block-color) 48%, white) 0 13%, color-mix(in srgb, var(--block-color) 90%, white) 14% 25%, var(--block-color) 26% 76%, color-mix(in srgb, var(--block-color) 76%, black) 77% 100%); opacity: 0; box-shadow: inset 0 3px 0 rgba(255,255,255,.48), inset 0 -4px 0 rgba(0,18,34,.18), 0 3px 5px rgba(0,17,30,.28), 0 0 9px color-mix(in srgb, var(--block-color) 42%, transparent); transform: scale(.88); transition: opacity .15s ease, transform .18s cubic-bezier(.2,.8,.25,1.15), filter .15s ease; }
...
.board-cell.occupied::before { opacity: 1; filter: saturate(1.22) brightness(1.06); transform: scale(1); }
...
.piece-cell::after { content: ''; position: absolute; z-index: 1; inset: 2px; border: 1px solid color-mix(in srgb, var(--block-color) 68%, white); border-radius: 13%; background: linear-gradient(180deg, color-mix(in srgb, var(--block-color) 48%, white) 0 13%, color-mix(in srgb, var(--block-color) 90%, white) 14% 25%, var(--block-color) 26% 76%, color-mix(in srgb, var(--block-color) 76%, black) 77% 100%); box-shadow: inset 0 3px 0 rgba(255,255,255,.5), inset 0 -4px 0 rgba(0,18,34,.18), 0 3px 5px rgba(0,25,42,.26), 0 0 9px color-mix(in srgb, var(--block-color) 40%, transparent); filter: saturate(1.22) brightness(1.06); }
