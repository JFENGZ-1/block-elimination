...
.board-cell::before { content: ''; position: absolute; inset: 1px; border: 1px solid color-mix(in srgb, var(--block-color) 58%, white); border-radius: inherit; background: linear-gradient(180deg, color-mix(in srgb, var(--block-color) 35%, white) 0 16%, var(--block-color) 17% 79%, color-mix(in srgb, var(--block-color) 72%, black) 80% 100%); opacity: 0; box-shadow: inset 0 3px 0 rgba(255,255,255,.28), inset 0 -4px 0 rgba(0,18,34,.2), 0 3px 5px rgba(0,17,30,.3), 0 0 6px color-mix(in srgb, var(--block-color) 24%, transparent); transform: scale(.88); transition: opacity .15s ease, transform .18s cubic-bezier(.2,.8,.25,1.15), filter .15s ease; }
.board-cell::after { display: none; }
.board-cell.occupied::before { opacity: 1; filter: saturate(1.08); transform: scale(1); }
.board-cell.occupied::after { opacity: 0; }
.board-cell.ghost-valid::before { opacity: .58; transform: scale(1); }
.board-cell.ghost-valid::after { opacity: 0; }
...
.piece-cell::after { content: ''; position: absolute; z-index: 1; inset: 2px; border: 1px solid color-mix(in srgb, var(--block-color) 58%, white); border-radius: 13%; background: linear-gradient(180deg, color-mix(in srgb, var(--block-color) 35%, white) 0 16%, var(--block-color) 17% 79%, color-mix(in srgb, var(--block-color) 72%, black) 80% 100%); box-shadow: inset 0 3px 0 rgba(255,255,255,.3), inset 0 -4px 0 rgba(0,18,34,.2), 0 3px 5px rgba(0,25,42,.28), 0 0 6px color-mix(in srgb, var(--block-color) 22%, transparent); }
.piece-cell::before { display: none; }
