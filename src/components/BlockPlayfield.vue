...
.board-cell::before { content: ''; position: absolute; inset: 0 0 2px; border: 1px solid rgba(3,16,25,.82); border-radius: 2px; background: conic-gradient(from 45deg at 50% 50%, color-mix(in srgb, var(--block-color) 68%, black) 0 25%, color-mix(in srgb, var(--block-color) 52%, black) 25% 50%, color-mix(in srgb, var(--block-color) 76%, white) 50% 75%, color-mix(in srgb, var(--block-color) 44%, white) 75% 100%); opacity: 0; box-shadow: 0 2px 0 #041922, 0 3px 4px rgba(0,14,23,.42); transform: scale(.9); transition: opacity .15s ease, transform .18s cubic-bezier(.2,.8,.25,1.15), filter .15s ease; }
.board-cell::after { content: ''; position: absolute; z-index: 1; left: 15%; top: 18%; width: 70%; height: 64%; border: 1px solid rgba(255,255,255,.1); border-radius: 1px; background: linear-gradient(145deg, color-mix(in srgb, var(--block-color) 78%, white) 0%, var(--block-color) 48%, color-mix(in srgb, var(--block-color) 84%, black) 100%); box-shadow: inset 2px 2px 3px rgba(255,255,255,.16), inset -2px -2px 3px rgba(0,15,25,.18); opacity: 0; pointer-events: none; transform: scale(.76); transition: opacity .15s ease, transform .18s ease; }
...
.piece-cell::after { content: ''; position: absolute; z-index: 1; inset: 0 1px 2px; border: 1px solid rgba(3,16,25,.82); border-radius: 2px; background: conic-gradient(from 45deg at 50% 50%, color-mix(in srgb, var(--block-color) 68%, black) 0 25%, color-mix(in srgb, var(--block-color) 52%, black) 25% 50%, color-mix(in srgb, var(--block-color) 76%, white) 50% 75%, color-mix(in srgb, var(--block-color) 44%, white) 75% 100%); box-shadow: 0 2px 0 #041922, 0 3px 4px rgba(0,14,23,.4); filter: saturate(1.2) brightness(1.06); }
.piece-cell::before { content: ''; position: absolute; z-index: 2; left: 15%; top: 18%; width: 70%; height: 64%; border: 1px solid rgba(255,255,255,.1); border-radius: 1px; background: linear-gradient(145deg, color-mix(in srgb, var(--block-color) 78%, white) 0%, var(--block-color) 48%, color-mix(in srgb, var(--block-color) 84%, black) 100%); box-shadow: inset 2px 2px 3px rgba(255,255,255,.16), inset -2px -2px 3px rgba(0,15,25,.18); pointer-events: none; }
