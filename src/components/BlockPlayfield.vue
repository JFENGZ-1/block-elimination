...
.board-cell::before { content: ''; position: absolute; inset: 1px 1px 3px; border: 1px solid color-mix(in srgb, var(--block-color) 68%, white); border-radius: inherit; background: linear-gradient(135deg, rgba(255,255,255,.48) 0 8%, transparent 8% 100%), linear-gradient(315deg, rgba(0,16,32,.22) 0 9%, transparent 9% 100%), linear-gradient(180deg, color-mix(in srgb, var(--block-color) 48%, white) 0 13%, color-mix(in srgb, var(--block-color) 90%, white) 14% 25%, var(--block-color) 26% 76%, color-mix(in srgb, var(--block-color) 72%, black) 77% 100%); opacity: 0; box-shadow: inset 4px 0 0 rgba(255,255,255,.14), inset -4px 0 0 rgba(0,18,34,.13), inset 0 4px 0 rgba(255,255,255,.48), inset 0 -5px 0 rgba(0,18,34,.24), 0 3px 0 color-mix(in srgb, var(--block-color) 58%, black), 0 5px 7px rgba(0,17,30,.3), 0 0 9px color-mix(in srgb, var(--block-color) 42%, transparent); transform: scale(.88); transition: opacity .15s ease, transform .18s cubic-bezier(.2,.8,.25,1.15), filter .15s ease; }
.board-cell::after { content: ''; position: absolute; z-index: 1; left: 17%; top: 17%; width: 46%; height: 13%; border-radius: 999px; background: linear-gradient(90deg, rgba(255,255,255,.82), rgba(255,255,255,.18)); box-shadow: 0 1px 3px rgba(255,255,255,.25); opacity: 0; pointer-events: none; transform: rotate(-5deg) scaleX(.7); transition: opacity .15s ease, transform .18s ease; }
.board-cell.occupied::before { opacity: 1; filter: saturate(1.22) brightness(1.06); transform: translateY(-1px) scale(1); }
.board-cell.occupied::after { opacity: .76; transform: rotate(-5deg) scaleX(1); }
.board-cell.ghost-valid::before { opacity: .58; transform: scale(1); }
.board-cell.ghost-valid::after { opacity: .28; transform: rotate(-5deg) scaleX(1); }
...
.piece-cell::after { content: ''; position: absolute; z-index: 1; inset: 1px 2px 4px; border: 1px solid color-mix(in srgb, var(--block-color) 68%, white); border-radius: 13%; background: linear-gradient(135deg, rgba(255,255,255,.48) 0 8%, transparent 8% 100%), linear-gradient(315deg, rgba(0,16,32,.22) 0 9%, transparent 9% 100%), linear-gradient(180deg, color-mix(in srgb, var(--block-color) 48%, white) 0 13%, color-mix(in srgb, var(--block-color) 90%, white) 14% 25%, var(--block-color) 26% 76%, color-mix(in srgb, var(--block-color) 72%, black) 77% 100%); box-shadow: inset 4px 0 0 rgba(255,255,255,.15), inset -4px 0 0 rgba(0,18,34,.14), inset 0 4px 0 rgba(255,255,255,.5), inset 0 -5px 0 rgba(0,18,34,.24), 0 4px 0 color-mix(in srgb, var(--block-color) 58%, black), 0 6px 8px rgba(0,25,42,.28), 0 0 9px color-mix(in srgb, var(--block-color) 40%, transparent); filter: saturate(1.22) brightness(1.06); transform: translateY(-1px); }
.piece-cell::before { content: ''; position: absolute; z-index: 2; left: 19%; top: 20%; width: 43%; height: 13%; border-radius: 999px; background: linear-gradient(90deg, rgba(255,255,255,.86), rgba(255,255,255,.18)); box-shadow: 0 1px 3px rgba(255,255,255,.25); pointer-events: none; transform: rotate(-5deg); }
