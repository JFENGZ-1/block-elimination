...
<style scoped>
.playfield-wrap { position: relative; }
.block-board { position: relative; display: grid; grid-template-columns: repeat(10, 1fr); gap: clamp(3px, .7vw, 5px); width: 100%; aspect-ratio: 1; padding: clamp(8px, 2vw, 14px); overflow: hidden; border: 2px solid rgba(152,245,255,.66); border-radius: 18px; background: #07384f; box-shadow: 0 0 20px rgba(93,239,255,.26), inset 0 0 35px rgba(0,20,41,.44); transition: border-color .3s ease, box-shadow .3s ease; }
.block-board.rescue-mode { border-color: rgba(255,211,78,.9); box-shadow: 0 0 0 3px rgba(255,178,32,.1), 0 0 28px rgba(255,158,24,.32), inset 0 0 42px rgba(105,48,0,.18); animation: rescue-board 1.25s ease-in-out infinite alternate; }
.board-cell { position: relative; aspect-ratio: 1; padding: 0; border: 1px solid rgba(117,222,240,.15); border-radius: 10%; background: rgba(1,30,51,.38); cursor: pointer; transition: transform .12s ease, background .12s ease; }
.board-cell::before { content: ''; position: absolute; inset: 1px 1px 3px; border: 1px solid color-mix(in srgb, var(--block-color) 68%, white); border-radius: 11%; background: linear-gradient(135deg, rgba(255,255,255,.62) 0 12%, transparent 12% 100%), linear-gradient(225deg, rgba(255,255,255,.24) 0 11%, transparent 11% 100%), linear-gradient(45deg, rgba(0,16,32,.2) 0 13%, transparent 13% 100%), linear-gradient(315deg, rgba(0,16,32,.32) 0 13%, transparent 13% 100%), linear-gradient(180deg, color-mix(in srgb, var(--block-color) 48%, white) 0 15%, var(--block-color) 16% 76%, color-mix(in srgb, var(--block-color) 68%, black) 77% 100%); opacity: 0; box-shadow: inset 4px 0 0 rgba(255,255,255,.14), inset -4px 0 0 rgba(0,18,34,.14), inset 0 4px 0 rgba(255,255,255,.44), inset 0 -5px 0 rgba(0,18,34,.25), 0 3px 0 color-mix(in srgb, var(--block-color) 56%, black), 0 5px 7px rgba(0,17,30,.3), 0 0 10px color-mix(in srgb, var(--block-color) 44%, transparent); transform: scale(.88); transition: opacity .15s ease, transform .18s cubic-bezier(.2,.8,.25,1.15), filter .15s ease; }
.board-cell::after { content: ''; position: absolute; z-index: 1; left: 18%; top: 18%; width: 64%; height: 56%; clip-path: polygon(16% 0, 84% 0, 100% 25%, 84% 100%, 16% 100%, 0 25%); background: conic-gradient(from 225deg at 50% 44%, rgba(255,255,255,.48) 0 25%, rgba(255,255,255,.14) 0 50%, rgba(0,18,34,.16) 0 75%, rgba(255,255,255,.28) 0), color-mix(in srgb, var(--block-color) 88%, white); box-shadow: inset 0 1px rgba(255,255,255,.38), inset 0 -2px rgba(0,18,34,.18), 0 2px 3px rgba(0,18,34,.14); opacity: 0; pointer-events: none; transform: translateY(2px) scale(.72); transition: opacity .15s ease, transform .18s ease; }
...
.piece-cell::after { content: ''; position: absolute; z-index: 1; inset: 1px 2px 4px; border: 1px solid color-mix(in srgb, var(--block-color) 68%, white); border-radius: 11%; background: linear-gradient(135deg, rgba(255,255,255,.62) 0 12%, transparent 12% 100%), linear-gradient(225deg, rgba(255,255,255,.24) 0 11%, transparent 11% 100%), linear-gradient(45deg, rgba(0,16,32,.2) 0 13%, transparent 13% 100%), linear-gradient(315deg, rgba(0,16,32,.32) 0 13%, transparent 13% 100%), linear-gradient(180deg, color-mix(in srgb, var(--block-color) 48%, white) 0 15%, var(--block-color) 16% 76%, color-mix(in srgb, var(--block-color) 68%, black) 77% 100%); box-shadow: inset 4px 0 0 rgba(255,255,255,.15), inset -4px 0 0 rgba(0,18,34,.14), inset 0 4px 0 rgba(255,255,255,.46), inset 0 -5px 0 rgba(0,18,34,.25), 0 4px 0 color-mix(in srgb, var(--block-color) 56%, black), 0 6px 8px rgba(0,25,42,.28), 0 0 10px color-mix(in srgb, var(--block-color) 42%, transparent); filter: saturate(1.22) brightness(1.06); transform: translateY(-1px); }
.piece-cell::before { content: ''; position: absolute; z-index: 2; left: 20%; top: 19%; width: 60%; height: 53%; clip-path: polygon(16% 0, 84% 0, 100% 25%, 84% 100%, 16% 100%, 0 25%); background: conic-gradient(from 225deg at 50% 44%, rgba(255,255,255,.5) 0 25%, rgba(255,255,255,.14) 0 50%, rgba(0,18,34,.16) 0 75%, rgba(255,255,255,.3) 0), color-mix(in srgb, var(--block-color) 88%, white); box-shadow: inset 0 1px rgba(255,255,255,.4), inset 0 -2px rgba(0,18,34,.18), 0 2px 3px rgba(0,18,34,.14); pointer-events: none; }
...
.effect-layer { position: absolute; z-index: 5; inset: 0; display: grid; grid-template-columns: repeat(10, 1fr); grid-template-rows: repeat(10, 1fr); gap: clamp(3px, .7vw, 5px); padding: clamp(8px, 2vw, 14px); pointer-events: none; }
