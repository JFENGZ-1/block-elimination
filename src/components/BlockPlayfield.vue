...
.board-cell { position: relative; aspect-ratio: 1; padding: 0; border: 1px solid rgba(131,198,202,.2); border-radius: 1px; background: rgba(5,42,50,.78); box-shadow: inset 0 0 5px rgba(0,19,28,.3); cursor: pointer; transition: transform .12s ease, background .12s ease; }
